-- ════════════════════════════════════════════════════════════════════════════════
-- SCRIPT 36c: Corrige usp_ReporteGerenciaCompras
-- Fix 1: DATEADD(MILLISECOND) no soportado en tipo DATE → castear a DATETIME
-- Fix 2: dbo.ORDEN_COMPRA no existe → nombre real es dbo.OrdenCompra
-- ════════════════════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    -- Castear a DATETIME para poder usar MILLISECOND en DATEADD
...
END
GO
PRINT 'OK: usp_ReporteGerenciaCompras corregida (OrdenCompra + DATETIME cast).';
GO
